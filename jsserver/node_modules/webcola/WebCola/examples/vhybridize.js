    ...
    */
    ...
    function powerGraph2(callback) {
        ...
        var label = svg.selectAll(".label")
            ...
            .enter().append("text")
            .attr("class", "label")
            .text(function (d) { return d.name; }).call(pgLayout.cola.drag);
        node.append("title").text(function (d) { return d.name; });
        ...
        var parentnodes = inputjson.nodes.filter(function (nv) { return nv.parent; });
        var noparentgroups = pgLayout.powerGraph.groups.filter(function (ng) {
            return ng.parent == null;
        });
        var parentgroups = pgLayout.powerGraph.groups.filter(function (ng) { return ng.parent; });
        var left = [];
        var above = [];
        var xoverlap = [];
        var yoverlap = [];
        noparentnodes.forEach(function (np) {
            noparentnodes.forEach(function (npv) {
        ...
        noparentgroups.forEach(function (np) {
            noparentgroups.forEach(function (npp) {
        ...
        parentnodes.forEach(function (np) {
            parentnodes.forEach(function (npv) {
        ...
        parentgroups.forEach(function (np) {
            parentgroups.forEach(function (npp) {
        ...
        pgLayout.powerGraph.groups.forEach(function (g) {
            var m = [];
            expandGroup(g, m);
            modules.ms.push(m);
        });
        pgLayout.powerGraph.powerEdges.forEach(function (e) {
    ...
    powerGraph2(function () { });
})(vhybridize || (vhybridize = {}));
//# sourceMappingURL=vhybridize.js.map