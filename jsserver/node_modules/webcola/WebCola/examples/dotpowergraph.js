...
(function (dotpowergraph) {
    ...
    function gridify(svg, pgLayout, margin, groupMargin) {
        ...
        svg.selectAll(".group").transition().attr('x', function (d) { return d.routerNode.bounds.x; })
            .attr('y', function (d) { return d.routerNode.bounds.y; })
            .attr('width', function (d) { return d.routerNode.bounds.width(); })
            .attr('height', function (d) { return d.routerNode.bounds.height(); })
    ...
    function createPowerGraph(inputjson) {
        ...
        function dragStart(d) {
            ghosts = [1, 2].map(function (i) { return svg.append('rect')
                .attr({
                class: 'ghost',
        ...
        function getDragPos(d) {
            var p = getEventPos(), startPos = eventStart[d.routerNode.id];
        ...
        function dragEnd(d) {
            ...
            d.x = dropPos.x;
            d.y = dropPos.y;
            ghosts.forEach(function (g) { return g.remove(); });
...
//# sourceMappingURL=dotpowergraph.js.map